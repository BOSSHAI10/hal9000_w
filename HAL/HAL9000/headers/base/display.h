...
// screen size
#define CHARS_PER_LINE              144
#define BYTES_PER_LINE              288
#define LINES_PER_SCREEN            50
...
typedef struct _DISPLAY_INFORMATION
{
    ...
    DWORD       FrameBufferGreenMaskSize;
    DWORD       FrameBufferBlueFieldPosition;
    DWORD       FrameBufferBlueMaskSize; 
